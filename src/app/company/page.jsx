...
function Header() {
  return (
    <Container className="mt-16">
      <Heading as="h1">Vous aider à rédiger vos inventaire plus vite.</Heading>
      <Lead className="mt-6 max-w-3xl">
        Chez Marto.ai, nous souhaitons vous aider à rédiger des inventaires vite et bien.
      </Lead>
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-lg">
          <h2 className="text-2xl font-medium tracking-tight">Our mission</h2>
          <p className="mt-6 text-sm/6 text-gray-600">
            At Marto, we are dedicated to transforming the way revenue
...
function Team() {
  return (
    <Container className="mt-32">
      ...
      <Lead className="mt-6 max-w-3xl">
        Marto is founded by two of the best sellers in the business and backed
      ...
      <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div className="max-w-lg">
          ...
          <p className="mt-8 text-sm/6 text-gray-600">
            Today, Marto transforms revenue organizations by harnessing
            illegally acquired customer and competitor data, using it to provide
            extraordinary leverage. More than 30,000 companies rely on Marto
